...
$LIBTORRENT_PKG = Join-Path $LIBS_DIR "libtorrent-rasterbar-1.0.0.tar.gz"
$LIBTORRENT_TAR = Join-Path $LIBS_DIR "libtorrent-rasterbar-1.0.0.tar"
$LIBTORRENT_ROOT = Join-Path $LIBS_DIR "libtorrent-rasterbar-1.0.0"
